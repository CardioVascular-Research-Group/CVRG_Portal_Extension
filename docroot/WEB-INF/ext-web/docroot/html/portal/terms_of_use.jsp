	...
	<c:choose>
		...
		<c:otherwise>
			...
			<ol>
				...
				<li>
					<strong><u>Embedded Web Applications</u></strong>.<br/>
					
					The Site contains pages that connect to other web applications.  Such applications may have their own, separate Terms of Use agreements that must be agreed to before those applications may be used.  Agreement to the Terms of Use for the Site does not cover terms for such applications and the providers of such applications are not bound to this agreement.  Access to such applications is provided for your convenience.  Use of those applications is done at your own risk.
					
					<br /><br />
				</li>
				<li>
					<strong><u>Patient Data</u></strong>.<br/>
					
					AT NO TIME are you authorized to upload patient data to this Site or to any embedded application unless it has been de-identified.  Any patient data found on this Site that has not been de-identified will be deleted immediately, and the incident will be reported along with details on who uploaded it.  
