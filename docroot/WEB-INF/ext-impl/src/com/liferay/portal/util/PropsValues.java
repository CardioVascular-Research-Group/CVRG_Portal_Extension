...
public class PropsValues {
	...
	public static final String CILOGON_USER_VALUE = PropsUtil.get(PropsKeys.CILOGON_USER_VALUE);
	//
	
	//Chris Jurado 1 August 2012
	//Johns Hopkins University Institute for Computational Medicine
	public static final boolean GLOBUSNEXUS_AUTH_ENABLED = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.GLOBUSNEXUS_AUTH_ENABLED));
	//
